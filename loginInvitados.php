...
<body>
    ...
    <div class="formulario">
        <div class="mover">
            <form method="POST" action="./componentes/conexiones/conInvitados.php">
                <div>
                    <div class="acceder">
                        <div class="im-logo">
                        ...
                        <h1 draggable="false" class="ac">INVITADO</h1>
                    </div>
                    <div class="mov-inputs">
                        <div class="input"><img draggable="false" src="img/456212.png" alt=""><input type="number"
                                placeholder="Documento / RIF" id="nombre" name="cedula" required></div>
