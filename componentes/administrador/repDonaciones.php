<?php
include ("../../componentes/administrador/repDonacionesForm.php");
    ...
    <section class="repEgresos"> <!-- La sección de egreso-->
        ...
        <div class="repEgresosShape"><!-- El cuerpo de la pagina de egreso-->
            ...
            <div class="titleheader">
                <p> Registrar Aporte</p> <!--Titulo de la Pagina-->
            </div>
            <hr>
            <div class="formShape">
                <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post" id="formularioEgreso">
                    ...
                    <div class="br">
                        ...
                        <input  type="datetime-local" value="<?php echo date('Y-m-d\TH:i:s'); ?>" name="fechaPagoIngreso" required readonly>
                ...
                uno selecciona Transferencia de fondos. PDT SI UNO SELECCIONA EFECTIVO SOLO DEBE QUEDARSE ASI-->
                    <div class="br">
                        ...
                        <!--Causas aqui añadan la opcion de que al seleccionar el banco se muestre el codigo del banco seleccionado
                    ...
                    <div class="buttonsReport">
                        <button id="volverAportes" class="volverEgresos" type="button">Volver</button>
